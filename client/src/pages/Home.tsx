    ...
    <div className="min-h-screen">
      ...
      <section className="relative min-h-screen flex items-center overflow-hidden">
        ...
        <div className="container mx-auto px-6 md:px-12 relative z-10">
          <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center py-20 pt-24">
            {/* Left: Content */}
            <div className="space-y-8">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
                <span className="block text-slate-900 dark:text-white">Speak Any</span>
                <span className="block text-slate-900 dark:text-white">Language,</span>
              ...
              <div className="grid grid-cols-3 gap-8 pt-8">
                <div>
                  ...
                  <div className="text-sm text-slate-500 dark:text-slate-400 mt-1">Languages</div>
                </div>
                <div>
                  <div className="text-2xl font-bold text-slate-900 dark:text-white">&lt;100ms</div>
                  <div className="text-sm text-slate-500 dark:text-slate-400 mt-1">Latency</div>
                </div>
                <div>
                  <div className="text-2xl font-bold text-slate-900 dark:text-white">Live</div>
                  <div className="text-sm text-slate-500 dark:text-slate-400 mt-1">Translation</div>
                </div>
              </div>
            </div>
            ...
            <div className="relative">
              ...
              <div className="relative bg-slate-100/80 dark:bg-slate-900/80 backdrop-blur-xl border border-slate-300/50 dark:border-slate-700/50 rounded-3xl p-8 shadow-2xl">
                <div className="space-y-6">
                  ...
                  <div className="relative group">
                    ...
                    <div className="relative flex items-start gap-4 p-5 bg-white/80 dark:bg-slate-800/80 rounded-2xl">
                      <div className="relative flex-shrink-0">
                        ...
                        <div className="absolute -bottom-1 -right-1">
                          <div className="h-4 w-4 bg-success rounded-full border-2 border-white dark:border-slate-900 animate-pulse" />
                        </div>
                      </div>
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-foreground font-medium">"Hello! How are you today?"</p>
                  ...
                  <div className="flex items-center justify-center gap-3">
                    ...
                    <div className="relative">
                      ...
                      <div className="relative h-12 w-12 rounded-full bg-gradient-to-br from-primary/20 to-accent/20 backdrop-blur-sm flex items-center justify-center ring-1 ring-border">
                  ...
                  <div className="relative group">
                    ...
                    <div className="relative flex items-start gap-4 p-5 bg-white/80 dark:bg-slate-800/80 rounded-2xl">
                      <div className="relative flex-shrink-0">
                        ...
                        <div className="absolute -bottom-1 -right-1">
                          <div className="h-4 w-4 bg-success rounded-full border-2 border-white dark:border-slate-900" />
                        </div>
                      </div>
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-2">
                        ...
                        <p className="text-foreground font-medium">"¡Hola! ¿Cómo estás hoy?"</p>
